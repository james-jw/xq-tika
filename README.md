...
<h3>Functionality</h3>
The xq-tika module currently exposes one method <pre>parseToString($file-path as xs:string) as xs:string</pre>. Upon execution, the type of file is automatically detected and text contents returned utilizing the Tika libraries. <p />
